...
System.register(['miruken-core', 'miruken-callback'], function (_export, _context) {
    ...
    var Metadata, $isFunction, $isPlainObject, isDescriptor, Variance, decorate, $flatten, $equals, Base, Protocol, StrictProtocol, typeOf, $isNothing, $classOf, design, instanceOf, $isSymbol, getPropertyDescriptors, emptyArray, $define, addDefinition, Handler, $handle, $composer, $unhandled, _desc, _value, _obj, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _desc2, _value2, _obj2, mappingMetadataKey, mapping, formatMetadataKey, $mapFrom, $mapTo, format, Mapping, Mapper, MapCallback, MapFrom, MapTo, MappingHandler, AbstractMapping, JsonFormat, JsonContentType, JsonMapping;
